    ...
    return(
        ...
        <Page size="A4" style={styles.page}>
            ...
            <View style={styles.body}>                      
                ...
                <Text style={styles.textBody}>BOBINA: {coil}</Text>
                <Text style={styles.textBody}>ANTICONGELANTE: {antifreeze}</Text>
                <Text style={styles.textBody}>CAMBIO DE ACEITE DE TRANSMISIÓN: {transmission}</Text>
            </View>
        </Page>
    </Document>
    )
