        ...
        for(let i = 0; i < products.length; i++){
            productsToRender.push(
                <View style={styles.productNameContainer} key={Math.random().toString()}>
                    <Text style={styles.text}>{ products[i].product.interfil ? products[i].product.interfil : products[i].product.NGK ? products[i].product.NGK : products[i].product.Roadstar ? products[i].product.Roadstar : products[i].product.Wagner }</Text>
                    <Text style={styles.text}>{products[i].quantity}</Text>
                </View>
            )
        }
